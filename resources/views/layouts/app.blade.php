    ...
    <header class="">
        ...
        <nav class="navbar navbar-default">
            ...
            <div class="collapse navbar-collapse js-navbar-collapse">
                ...
                <!--barra de busca-->
                <div class="col-md-8 col-md-offset-2" id="grupo-busca">
                ...
                <ul class="nav navbar-nav">
                    <li class="dropdown mega-dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Coleções <span class="glyphicon glyphicon-chevron-down pull-right"></span></a>
                        <ul class="dropdown-menu mega-dropdown-menu row">
                            ...
                            <li class="col-sm-3">
                            <ul>
                                <li class="dropdown-header">Feminino</li>
                            ...
                            <li class="col-sm-3">
                            <ul>
                                <li class="dropdown-header">Masculino</li>
                                <li><a href="#">Camisetas</a></li>
                                <li><a href="#">Shorts</a></li>
                                <li><a href="#">Esportivos</a></li>
                                <li class="divider"></li>
                                <li class="dropdown-header">Calçados</li>
        ...
        <div class="admin col-md-5 pull-right">
            @if(!auth()->guest())
                @if(auth()->user()->isAdmin)
                    <div class="alert alert-success" role ="alert">
                        <strong>Logado como Administrador!&nbsp&nbsp  </strong>
                          <a href="{{ url('/admin') }}" class="alert-link">Painel administrativo <span class="glyphicon glyphicon-log-out" aria-hidden="true">&nbsp</span></a>
                    </div>
                @endif       
            @endif
        </div>
